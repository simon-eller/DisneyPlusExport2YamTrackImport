...
Bridge the gap between your Disney+ binge-watching sessions and your **Yamtrack** profile. This Python script takes your Disney+ data export, matches it against **The Movie Database (TMDB)**, and generates a pixel-perfect CSV file ready for bulk import.
...
## ⚠️ Troubleshooting
* **"Series not found":** Check `import_errors.log`. Some titles on Disney+ differ slightly from the official database. You may need to edit the CSV manually for those rare cases.
